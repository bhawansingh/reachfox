...
<div class="row forms" id="mainContent">
	...
	<div class="small-12 medium-9 large-9 columns">
		<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>index.php?action=feedbackUpdate" id="homeUser" method="post" data-abide>
			<!-- User form -->
				...
				<div class="row">
				    ...
				    <div class="large-12 columns">
			        	<label for="right-label" class="right inline text-left error">First Name
				          	<input id="firstName" name="firstName" type="text" value="<?php echo $this->model->getfirstName(); ?>" required >
				    ...
				    <div class="large-12 columns">
			        	<label for="right-label" class="right inline text-left error">Last Name
			          		<input id="lastName" name="lastName" 
		                           accept=""type="text" placeholder="" value="<?php echo $this->model->getlastName(); ?>" required>
			          		<span class="cross">x</span>
			          	</label>
				    </div>
                    				    <div class="large-12 columns">
			        	<label for="right-label" class="right inline text-left error">Email
				          	<input id="email" name="email" type="text" value="<?php echo $this->model->getEmail(); ?>" required >
				          	<span class="cross">x</span>
				         </label>
				    </div>
				    ...
				    <div class="large-12 columns">
			        	<label for="right-label" class="right inline text-left error">Message
			          		<input id="message" name="message" 
		                           accept=""type="text" placeholder="" value="<?php echo $this->model->getMessage(); ?>" required>
			          		<span class="cross">x</span>
			          	</label>
				    </div>
				    ...
				    <div class="large-12 columns">
				      <div class="row collapse prefix-radius">
				          <input class="button large and radius" id="feedbackUpdate" name="feedbackUpdate" type="Submit" value="Submit">
				      </div>
				    </div>
		            ...
		            <table>
							...
							foreach($resultSet as $test)
							{
								...
								echo"<td> 
                                <a href ='index.php? action=feedbackUpdate&id=$id'>Edit</a>";
								echo"<td> 
